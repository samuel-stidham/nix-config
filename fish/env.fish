...
# Personal Settings
# ================================
set -x DEFAULT_USER samuelstidham
...
set -x GOPROJECTS "$CODE/go-projects"
...
# TeX Live
# ================================
set -x TEXLIVE_HOME /usr/local/texlive/2026
...
source $FISH_CONFIG/functions.fish
